		...
		<div class="w-full max-w-md">
			{#if validatingToken}
				...
				<div class="text-center" use:fadeSlideIn>
					<div class="inline-flex items-center justify-center w-16 h-16 mb-4 bg-accent-primary/10 rounded-full">
			...
			{:else if !tokenValid}
				<!-- Invalid Token State -->
				<div class="text-center" use:fadeSlideIn>
					<div class="inline-flex items-center justify-center w-16 h-16 mb-4 bg-error/10 rounded-full">
