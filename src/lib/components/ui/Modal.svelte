...
{#if isOpen}
  ...
  >
    <div
      ...
      aria-modal="true"
      tabindex="-1"
      class="modal-content bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 p-6 w-full {maxWidthClasses[maxWidth]} max-h-[90vh] overflow-y-auto {className}"
